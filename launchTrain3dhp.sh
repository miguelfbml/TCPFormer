...
python3 train_3dhp.py --config configs/mpi/TCPFormer_mpi_27.yaml --checkpoint checkpoint_mpi --checkpoint-file TCPFormer_mpi_27.pth.tr --new-checkpoint checkpoint_mpi_GT --use-wandb --wandb-name "TCPFormer_MPI_GT_training"