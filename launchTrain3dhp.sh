...
python3 train_3dhp.py --config configs/mpi/TCPFormer_mpi_27.yaml --checkpoint checkpoint_mpi --checkpoint-file TCPFormer_mpi_27.pth.tr --new-checkpoint checkpoint_mpi --use-wandb --wandb-name "TCPFormer_MPI_3DHP_resume_training_YOLOv11"