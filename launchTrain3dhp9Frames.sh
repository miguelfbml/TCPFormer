...
#SBATCH --job-name=trainTCPFormer3dhp9Frames    # Job name
...
python3 train_3dhp.py \
    --config configs/mpi/TCPFormer_mpi_9.yaml \
    --checkpoint checkpoint_mpi \
    --checkpoint-file TCPFormer_mpi_9.pth.tr \
    --new-checkpoint checkpoint_mpi_9 \
    --use-wandb \
    --wandb-name "TCPFormer_MPI_3DHP_9_frames_training"