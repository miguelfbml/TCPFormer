...
#SBATCH --job-name=trainTCPFormer3dhp1Frames    # Job name
...
python3 train_3dhp.py \
    --config configs/mpi/TCPFormer_mpi_1.yaml \
    --new-checkpoint checkpoint_mpi_1 \
    --use-wandb \
    --wandb-name "TCPFormer_MPI_3DHP_1_frame_training"