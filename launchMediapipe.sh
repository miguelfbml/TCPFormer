...
python3 calculate_metrics_mediapipe.py --config ../../../configs/mpi/TCPFormer_mpi_27.yaml --checkpoint ../../../checkpoint_mpi --checkpoint-file TCPFormer_mpi_27.pth.tr --sequence-name TS1