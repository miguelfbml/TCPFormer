...
#SBATCH --job-name=trainTCPFormer3dhp81Frames    # Job name
...
python3 train_3dhp.py \
    --config configs/mpi/TCPFormer_mpi_81.yaml \
    --checkpoint checkpoint_mpi \
    --checkpoint-file TCPFormer_mpi_81.pth.tr \
    --new-checkpoint checkpoint_mpi_81 \
    --use-wandb \
    --wandb-name "TCPFormer_MPI_3DHP_81_frames_training"