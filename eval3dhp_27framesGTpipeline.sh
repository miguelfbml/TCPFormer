...
python3 train_3dhp.py --eval-only --checkpoint checkpoint_mpi_27GT_Pipeline --checkpoint-file TCPFormer_mpi_27.pth.tr --config configs/mpi/testing/TCPFormer_mpi_27.yaml
