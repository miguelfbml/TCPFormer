...
def main():
    ...
    try:
        while True:
            ...
            # Display inference FPS and time
            if args.show_fps:
        ...
        if len(inference_times) > 0:
            ...
            print(f"Final average inference FPS: {final_inference_fps:.1f}")
            print(f"Final average inference time: {final_avg_inference*1000:.1f}ms")
