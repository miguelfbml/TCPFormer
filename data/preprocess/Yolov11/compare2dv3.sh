...
#SBATCH --job-name=testingTimev3    # Job name
...
python3 compare_gt_yolo_2d.py --all --model-path runs/pose/model3/best.pt --img-size 640 --batch-size "$BATCH_SIZE" --device "$DEVICE"
